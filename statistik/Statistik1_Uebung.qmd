...
nicht zuverlässig (siehe "Warning message"). Darum wird mit Fishers 
...
p <- ggplot(df, aes(x = condit, y = tot_sold)) +
  geom_boxplot(color = "black", size = 1, width = 0.65) +
  #geom_dotplot(binaxis = "y", stackdir = "center", alpha = 0.5, size = 0.2) +
  labs(y = "Verkaufte Gerichte pro Woche") +
