...
Als erstes wollen wir für den Datensätze `rotmilan` Dichteschätzungen durchführen. Lade vorgängig die dafür notwendigen Packages in deine R-Session.
...
Wir wollen dies nun ausprobieren und konstruieren zum Schluss die Thiessen Polygone für die Rotmilan-Daten für das Untersuchungsgebiet Schweiz. Nutze die Anleitung aus der @sec-thiessen für das Erstellen von Thiessen Polygonen.
...
#| fig.cap: 'Wenn wir jetzt die Thiessen Polygone (ohne Punkte) darstellen, wird deutlicher,
