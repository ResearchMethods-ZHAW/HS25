...
Nutze den obigen Code, um den Strassen-Datensatz zu rasterisieren und die Distanz zu Strassen mit der Funktion `distance()` zu berechnen. Plausibilisiere den Output, indem du ihn visualisierst.
