...
DF_mod <- read_delim("datasets/fallstudie_n/Aufgabe_4/Aufgabe4_Datensatz_Modelle_Habitatnutzung_Reh_251027.csv", delim = ";")
...
m <- glm(pres_abs ~ x, data = DF_mod_day, family = binomial)
