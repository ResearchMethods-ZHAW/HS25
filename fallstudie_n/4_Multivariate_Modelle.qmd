...
DF_mod <- read_delim("datasets/fallstudie_n/Aufgabe4/Aufgabe4_Datensatz_Modelle_Habitatnutzung_Reh_251027.csv", delim = ";")
...
Für jede kontinuierliche Variable: Passe ein binomiales GLM (pres_abs ~ x), berechne Pearson-Residuen und macht Histogramm + Q-Q-Plot (Residuals sollen grob „normal“ wirken). Wenn starke Abweichungen (krummes Histogramm, Q-Q-Punkte weit von der Linie): probiert Transformation, passt das Modell neu und prüft die Residuen nochmal
