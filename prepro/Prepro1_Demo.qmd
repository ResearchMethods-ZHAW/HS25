...
Folgendermassen wird eine Fliesskommazahl einer Variabel zuweisen:
...
Mit `c()` können [eine Reihe von Werten vom gleichen Datentyp]{.underline} einer Variabel zugewiesen werden (als `vector`). 
