---
title: "Infovis 1: Blogbeitrag Kovic"
---

# Je weniger Ausländer, desto mehr Ja-Stimmen? Wirklich?{#sec-kovic2014}
...
![](blogpost-images/img_header.png)
...
![](blogpost-images/Kantone-2.png){#fig-kantone}
...
![](blogpost-images/Kantone-LOESS.png){#fig-kantone-loess}
...
![](blogpost-images/Gemeinden-2-986x939.png){#fig-gemeinden}
...
![](blogpost-images/Gemeinden-GAM-2-986x939.png){#fig-gemeinden-gam}
...
![](blogpost-images/Gemeinden-x-Kantone-2-986x857.png){#fig-gemeinden-x-kantone}
...
![](blogpost-images/Gemeinden-x-Kantone-LOESS-2-986x857.png){#fig-gemeinden-x-kantone-loess}
...
![](blogpost-images/Gemeinden-x-Quantile-2-986x637.png){#fig-gmeinden-x-quantile}
...
![](blogpost-images/Gemeinden-x-Quantile-LOESS-2-986x637.png){#fig-gmeinden-x-quantile-loess}
