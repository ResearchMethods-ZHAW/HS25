...
## Aufgabe 2 {#sec-infovis2-scatterplot}
...
## Aufgabe 3 {#sec-infovis2-aggregate}
...
Wiederhole nun den Plot aus @sec-infovis2-scatterplot mit den aggregierten Daten aus @sec-infovis2-aggregate. Um die labels korrekt zu setzen, musst du `scale_x_datetime` mit `scale_x_date` ersetzen. 
